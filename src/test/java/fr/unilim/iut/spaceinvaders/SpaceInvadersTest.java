   ...
   @Test
    ...
    @Test
   	public void test_unNouveauEnvahisseurAvecDimensionEstCorrectementPositionneDansEspaceJeu() {
       	spaceinvaders.positionnerUnNouveauEnvahisseur(new Dimension(2,2),new Position(4,2), 1);
   		assertEquals("" + 
   		"...............\n" + 
   		"....EE.........\n" +
   		"....EE.........\n" + 
    ...
    public void test_EnvahisseurAvancePartiellement_DeplacerEnvahisseurVersLaDroite() {
       ...
       spaceinvaders.positionnerUnNouveauEnvahisseur(new Dimension(2,2),new Position(4,2),3);
    ...
    @Test
    public void test_CollisionEnvahisseurMissile_BasHaut(){
    	
    	spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(7,2),new Position(5,9), 1);
    	spaceinvaders.positionnerUnNouveauEnvahisseur(new Dimension(2,2),new Position(7,2),3);
    	spaceinvaders.tirerUnMissile(new Dimension(2,2),3);
